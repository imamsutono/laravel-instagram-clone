<div x-data="{shrink: false, drawer: false}"
    ...
    <div class="pt-3">
        ...
        <img x-cloak x-show="!(shrink || drawer)" src="{{ asset('assets/logo.png') }}"
            class="h-16 w-44 text-black" alt="logo">
    </div>
    ...
    <ul class="space-y-4 mt-2">
        ...
        <li>
            <a wire:navigate href="/" class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"
                    class="text-lg {{ request()->routeIs('explore') ? 'font-bold' : 'font-medium' }}">
                    Explore
                </h4>
            </a>
        </li>
    ...
    {{-- TODO: when you create sidebar as a livewire component use @teleport blade directive --}}
    <template x-teleport="body">
        <div x-show="drawer" class="fixed inset-y-0 left-[70px] w-96 bg-red-500 border rounded-r-2xl z-[5]"></div>
    </template>
</div>